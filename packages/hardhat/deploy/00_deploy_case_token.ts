 ...
 */
const deployCaseToken: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
...
export default deployCaseToken;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags YourToken
deployCaseToken.tags = ["CaseToken"];